...
public class SysLib {
    ...
    public static int open(String var1, String var2){
        String[] str = new String[]{var1, var2};
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.OPEN, 0, str);
    }
    ...
    public static int close(int fd){
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.CLOSE, fd, (Object)null );
    }

    public static int seek(int fd, int offset, int whence)
    {
        int [] buff = new int[]{offset, whence};
        return Kernel.interrupt(Kernel.INTERRUPT_SOFTWARE, Kernel.SEEK, fd, buff);
    }
