         ...
         case INTERRUPT_SOFTWARE: // System calls
            switch( cmd ) { 
               ...
               case READ:
                  switch ( param ) {
                     ...
                     case STDERR:
                        ...
                        return ERROR;
                     default:
                         fileTableEntry = getFileTableEntry(param);
                         if (fileTableEntry == null) {
                             return ERROR;
                         }
                         return fs.read(fileTableEntry, (byte[]) args);
               ...
               case WRITE:
                  switch ( param ) {
                     ...
                     default:
                        ...
                        return fs.write(fileTableEntry, (byte[]) args);
                  }
               ...
               case CLOSE:
                   ...
                   fileTableEntry = getFileTableEntry(param);
                   if (fileTableEntry == null || !fs.close(fileTableEntry)) {
                       return ERROR;
                   }
